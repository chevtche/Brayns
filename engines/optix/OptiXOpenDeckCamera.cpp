...
const std::string CUDA_OPENDECK_CAMERA = braynsOptixEngine_generated_OpenDeckCamera_cu_ptx;
                                 ...
                                 ::optix::Context context)
{
    ...
    context[CUDA_ATTR_CAMERA_SEGMENT_ID]->setUint(camera.getPropertyOrValue<int>("segmentId", 0));
